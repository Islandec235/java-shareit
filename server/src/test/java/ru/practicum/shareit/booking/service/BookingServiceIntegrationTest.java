...
public class BookingServiceIntegrationTest {
    ...
    public void shouldReturnBookingsByOwnerWithStateIsPAST() {
        List<BookingOutputDto> bookings =
                service.getBookingsByOwner(owner.getId(), BookingState.PAST, 0, 1);
    ...
    public void shouldReturnBookingsByOwnerWithStateIsALL() {
        List<BookingOutputDto> bookings = service.getBookingsByOwner(owner.getId(), BookingState.ALL, 0, 1);
    ...
    public void shouldReturnBookingsByOwnerWithStateIsFUTURE() {
        ...
        List<BookingOutputDto> bookings =
                service.getBookingsByOwner(owner.getId(), BookingState.FUTURE, 0, 1);
    ...
    public void shouldReturnBookingsByOwnerWithStateIsWAITING() {
        List<BookingOutputDto> bookings =
                service.getBookingsByOwner(owner.getId(), BookingState.WAITING, 0, 1);
    ...
    public void shouldReturnBookingsByOwnerWithStateIsREJECTED() {
        ...
        List<BookingOutputDto> bookings =
                service.getBookingsByOwner(owner.getId(), BookingState.REJECTED, 0, 1);
    ...
    public void shouldReturnBookingsByOwnerWithStateIsCURRENT() {
        ...
        List<BookingOutputDto> bookings =
                service.getBookingsByOwner(owner.getId(), BookingState.CURRENT, 0, 1);
