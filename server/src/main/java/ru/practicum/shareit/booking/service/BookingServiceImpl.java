...
public class BookingServiceImpl implements BookingService {
    ...
    @Override
    @Transactional(readOnly = true)
    public List<BookingOutputDto> getBookingsByUser(Long userId, BookingState state, Integer from, Integer size) {
    ...
    @Override
    @Transactional(readOnly = true)
    public List<BookingOutputDto> getBookingsByOwner(Long ownerId, BookingState state, Integer from, Integer size) {
        userValidation(ownerId);
