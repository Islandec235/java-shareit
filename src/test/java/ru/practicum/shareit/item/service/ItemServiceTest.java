...
public class ItemServiceTest {
    ...
    @Test
    public void shouldReturnExceptionForCreateWithEmptyAvailable() {
    ...
    public void shouldUpdate() {
        ...
        ItemDto updatedItem = service.update(itemDto, owner.getId());
    ...
    public void shouldReturnItemByIdWithBookings() {
        ...
        Booking lastBooking = new Booking(1L, LocalDateTime.now().minusDays(1), LocalDateTime.now().plusDays(2));
        Booking nextBooking = new Booking(2L, LocalDateTime.now().plusDays(3), LocalDateTime.now().plusDays(4));
    ...
    public void shouldCreateComment() {
        Booking booking = new Booking(1L, LocalDateTime.now().minusDays(1), LocalDateTime.now().plusDays(2));
        CommentDto commentDto = new CommentDto(1L, "text", "Test", Instant.now());
        Comment comment = new Comment(1L, "text", commentDto.getCreated());
